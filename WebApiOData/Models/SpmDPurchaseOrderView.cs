...
namespace WebApiOData.Models
{
    ...
    public partial class SpmDPurchaseOrderView
    {
        ...
        public Nullable<int> PartCategoryCount { get; set; }
        public Nullable<decimal> TotalDemandQuantity { get; set; }
        public Nullable<int> SoPartCategoryCount { get; set; }
        public Nullable<decimal> SoTotalDemandQuantity { get; set; }
        public Nullable<int> BoSoPartCategoryCount { get; set; }
        public Nullable<decimal> BoTotalDemandQuantity { get; set; }
        public Nullable<int> OutputPartCount { get; set; }
